...
"QLabel { color: rgb(40,40,40);  }"));
    ...
    void retranslateUi(ModalOverlay *ModalOverlay)
    {
        ...
        infoText->setText(QCoreApplication::translate("ModalOverlay", "Recent transactions may not yet be visible, and therefore your wallet's balance might be incorrect. This information will be correct once your wallet has finished synchronizing with the notecoin network, as detailed below.", nullptr));
        infoTextStrong->setText(QCoreApplication::translate("ModalOverlay", "Attempting to spend notecoins that are affected by not-yet-displayed transactions will not be accepted by the network.", nullptr));
