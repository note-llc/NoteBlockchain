...
#if QT_CONFIG(tooltip)
        label_3->setToolTip(QCoreApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the NoteCoin network.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        reqMessage->setToolTip(QCoreApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the NoteCoin network.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        useBech32->setText(QCoreApplication::translate("ReceiveCoinsDialog", "Generate native segwit (Bech32) address", nullptr));
