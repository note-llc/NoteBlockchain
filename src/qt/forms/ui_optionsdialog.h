...
#if QT_CONFIG(tooltip)
        mapPortUpnp->setToolTip(QCoreApplication::translate("OptionsDialog", "Automatically open the NoteCoin client port on the router. This only works when your router supports UPnP and it is enabled.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        connectSocks->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the NoteCoin network through a SOCKS5 proxy.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        connectSocksTor->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the NoteCoin network through a separate SOCKS5 proxy for Tor hidden services.", nullptr));
#endif // QT_CONFIG(tooltip)
        connectSocksTor->setText(QCoreApplication::translate("OptionsDialog", "Use separate SOCKS&5 proxy to reach peers via Tor hidden services:", nullptr));
