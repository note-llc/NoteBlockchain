...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QString::fromUtf8("0.00 NOTES"));
        ...
        labelCoinControlFee->setText(QString::fromUtf8("0.00 NOTES"));
        ...
        labelCoinControlAfterFee->setText(QString::fromUtf8("0.00 NOTES"));
        ...
        labelCoinControlChange->setText(QString::fromUtf8("0.00 NOTES"));
        ...
        labelBalance->setText(QString::fromUtf8("123.456 NOTES"));
...
#if QT_CONFIG(tooltip)
        checkBoxMinimumFee->setToolTip(QCoreApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for notecoin transactions than the network can process.", nullptr));
#endif // QT_CONFIG(tooltip)
        checkBoxMinimumFee->setText(QString());
#if QT_CONFIG(tooltip)
        labelMinFeeWarning->setToolTip(QCoreApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks. But be aware that this can end up in a never confirming transaction once there is more demand for notecoin transactions than the network can process.", nullptr));
#endif // QT_CONFIG(tooltip)
