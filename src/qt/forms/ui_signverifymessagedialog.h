...
#if QT_CONFIG(tooltip)
        signMessageButton_SM->setToolTip(QCoreApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this NoteCoin address", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        addressIn_VM->setToolTip(QCoreApplication::translate("SignVerifyMessageDialog", "The NoteCoin address the message was signed with", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        verifyMessageButton_VM->setToolTip(QCoreApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified NoteCoin address", nullptr));
#endif // QT_CONFIG(tooltip)
