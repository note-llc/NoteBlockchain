...
#if QT_CONFIG(tooltip)
        payTo->setToolTip(QCoreApplication::translate("SendCoinsEntry", "The NoteCoin address to send the payment to", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        checkboxSubtractFeeFromAmount->setToolTip(QCoreApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less notecoins than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        messageTextLabel->setToolTip(QCoreApplication::translate("SendCoinsEntry", "A message that was attached to the notecoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the NoteCoin network.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
